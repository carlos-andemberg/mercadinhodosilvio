...
export const metadata = {
  title: 'Localização | Mercadinho do Silvio',
  description: 'Saiba como chegar no Mercadinho do Silvio em Rio Largo - AL. Veja nosso endereço e horário de funcionamento.',
};
